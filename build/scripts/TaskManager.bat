...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "zabieru.taskmanager/zabieru.taskmanager.HelloApplication"
...
"%JAVA_EXE%" %JAVA_OPTS% %TASK_MANAGER_OPTS% %DEFAULT_JVM_OPTS% %CMD_LINE_ARGS%
